...
namespace ContosoUniversity.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder, string currentFilter, string searchString, int? pageNumber)
        {
            ...
            var students = _context.Students.Select(_ => _);
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            if (await TryUpdateModelAsync<Student>(studentToUpdate, string.Empty, s => s.FirstMidName, s => s.LastName, s => s.EnrollmentDate))
            {
                try
                {
                    await _context.SaveChangesAsync();
        ...
        you could avoid an unnecessary SQL query by instantiating a Student 
        entity using only the primary key value and then setting the entity state 
        to Deleted. That's all that the Entity Framework needs in order to delete the entity. 
