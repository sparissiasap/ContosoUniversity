...
namespace ContosoUniversity.Controllers
{
    public class InstructorsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var instructor = await _context.Instructors.Include(i => i.OfficeAssignment).AsNoTracking().FirstOrDefaultAsync(m => m.ID == id);
            if (instructor == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(int? id, string[] selectedCourses)
        {
            ...
            if (await TryUpdateModelAsync<Instructor>(instructorToUpdate, string.Empty, i => i.FirstMidName, i => i.LastName, i => i.HireDate, i => i.OfficeAssignment))
            {
